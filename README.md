...
| **Item**                             | **Beschrijving**                               |
|--------------------------------------|-----------------------------------------------|
| [JFall (3 november 2023)](https://jfall.nl/)           | Jaarlijkse Java-conferentie. Gratis toegang als je een Java User Group NL membership hebt. |
| [JSpring (geen datum)](https://jspring.nl/)     | Jaarlijkse Java-conferentie.  Gratis toegang als je een Java User Group NL membership hebt. |
